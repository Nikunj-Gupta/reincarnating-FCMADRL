...
avg_reward_list = []
summary_writer = tf.summary.create_file_writer("logs/ddpg_new/")
...
for ep in range(total_episodes):
    ...
    with summary_writer.as_default():
        tf.summary.scalar('episode reward', ep_reward_list[-1], step=ep)
        tf.summary.scalar('running average reward (40)', avg_reward_list[-1], step=ep)
